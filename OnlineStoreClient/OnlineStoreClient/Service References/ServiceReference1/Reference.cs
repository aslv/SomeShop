...
namespace OnlineStoreClient.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        bool registerUser(string username, string password, bool type, System.DateTime dateOfBirth, bool gender, string email, string firstName, string lastName, bool role, double accBalance);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/registerUser", ReplyAction="http://tempuri.org/IService1/registerUserResponse")]
        System.Threading.Tasks.Task<bool> registerUserAsync(string username, string password, bool type, System.DateTime dateOfBirth, bool gender, string email, string firstName, string lastName, bool role, double accBalance);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<OnlineStoreClient.ServiceReference1.IService1>, OnlineStoreClient.ServiceReference1.IService1 {
        ...
        public bool registerUser(string username, string password, bool type, System.DateTime dateOfBirth, bool gender, string email, string firstName, string lastName, bool role, double accBalance) {
            return base.Channel.registerUser(username, password, type, dateOfBirth, gender, email, firstName, lastName, role, accBalance);
        }
        
        public System.Threading.Tasks.Task<bool> registerUserAsync(string username, string password, bool type, System.DateTime dateOfBirth, bool gender, string email, string firstName, string lastName, bool role, double accBalance) {
            return base.Channel.registerUserAsync(username, password, type, dateOfBirth, gender, email, firstName, lastName, role, accBalance);
        }
    }
}
